...
const navbar = () => {
    return (
        <nav class="bg-purple-400 border-gray-600 dark:bg-gray-900 dark:border-gray-700">
            <div class="group inline-block">
                <button
                    class="outline-none focus:outline-none border px-3 py-1 bg-purple-400 rounded-sm flex items-center min-w-32"
                >
                    <span class="bg-purple-400 pr-1 font-semibold flex-1">Dropdown</span>
                    <span>
                        <svg
